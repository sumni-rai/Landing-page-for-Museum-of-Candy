...
-- -----------------------------------------------------------------------------------
 ...
 local function changeScene()
	composer.gotoScene("shop" ,{ effect = "slideRight", time = 300 })
 end
...
function scene:create( event )
 ...
 sceneGroup:insert(bg)
  ...
  logo=display.newImage("logo1.jpg",display.contentCenterX, display.contentCenterY-178)
 logo:scale(0.37,0.37)
sceneGroup:insert(logo)

logo:addEventListener("tap", changeScene)
 title=display.newImage("3.jpg",display.contentCenterX, display.contentCenterY)
 title:scale(0.098,0.098)
sceneGroup:insert(title)

 myText= ("GOLD HANDCUFF")
...
sceneGroup:insert(textField)
 ...
 title=display.newImage("2.jpg",display.contentCenterX, display.contentCenterY)
 title:scale(0.098,0.098)
sceneGroup:insert(title)
